            ...
            <Col sm="6">
                <div className="video-item item">
                    ...
                    <ButtonToolbar className='video-item--actions'>
                        <Button onClick={() => handleVideoSelect(video)} className="video-item--actions-item video-item--actions-plus" title="Adicionar à sua playlist"><i className="fa fa-plus"></i></Button>
                    </ButtonToolbar>
                </div>
            </Col>
        </Fragment>

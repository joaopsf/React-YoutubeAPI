        ...
        return (
            <Form onSubmit={this.handleSubmit} className="search-video">
                <Row className="justify-content-md-center">
                    <Col md={3}><h3 className="search-video--title"><i className="fa fa-caret-right"></i> Buscar por palavra chave</h3></Col>
                    <Col xs={9} md={5}>
                    ...
                    <Col xs={3} md={1}>
                        <Button onClick={this.handleSubmit} block><i className="fa fa-search"></i></Button>
                    </Col>
                </Row>
            </Form>
        )
